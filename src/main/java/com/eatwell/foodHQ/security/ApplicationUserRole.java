...
//            ApplicationUserPermission.RESERVATION_READ)),
    ADMIN(Sets.newHashSet(
            ApplicationUserPermission.CUSTOMER_WRITE,
            ApplicationUserPermission.CUSTOMER_UPDATE,
            ApplicationUserPermission.CUSTOMER_DELETE,
            ApplicationUserPermission.RESERVATION_WRITE,
            ApplicationUserPermission.RESERVATION_UPDATE,
            ApplicationUserPermission.RESERVATION_DELETE
    )),
